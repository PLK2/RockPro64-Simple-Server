...
5. We're going to **verify** the files just downloaded (to make sure they are complete and also not malicious). In Terminal within your Downloads directory, run: `shasum -a 256 firmware.rockpro64-rk3399.img.gz' and then `shasum -a 256 partition.img.gz`.
